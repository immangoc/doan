...
export async function fetchRecommendation(
  ...
  // Enforce area constraints (1-based bayNo):
  // 40ft → right-half (bayNo >= 5). 20ft has no such restriction.
  ...
  // Do NOT clamp 20ft to left half; 20ft can be placed anywhere as long as support/collision rules pass.
