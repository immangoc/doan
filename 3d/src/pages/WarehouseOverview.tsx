...
export function WarehouseOverview() {
  ...
  function navigateToWarehouse(whId: WHType) { navigate(`/3d?wh=${whId}`); }
      ...
      <div className="ov-page">
        ...
        <div className="ov-header">
          ...
          <div className="ov-header-actions">
            <button className="ov-btn-nav" onClick={() => navigate('/3d')}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', paddingBottom: 20 }}>
          <button className="ov-btn-nav" onClick={() => navigate('/3d')} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 16px', borderRadius: 8, border: '1px solid #bfdbfe', background: '#eff6ff', color: '#1d4ed8', fontSize: '0.82rem', fontWeight: 600, cursor: 'pointer' }}>
